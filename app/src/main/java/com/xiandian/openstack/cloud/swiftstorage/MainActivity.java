...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {//导航选择操作
        ...
        //文档
        else if (id == R.id.nav_doc) {//改的文档
            if (docCategoryFragment == null){
                docCategoryFragment =new CategoryFragment();
                Bundle bundle =new Bundle();
                //传递参数到 CategoryFragment  指定参数 mime.在fragment 中不能使用构造方法传递参数
                bundle.putStringArray("mime",Constants.MIME_DOC);
                //Fragment保存参数 传递一个 bundle
